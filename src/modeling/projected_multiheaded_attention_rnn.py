...
from .modules import PretrainedEmbeddingLayer, CellLayer, MultiLayerPerceptron, AttendedState, SequentialModel, SpatialDropout


class ProjectedMultiHeadedAttentionRNN(Module):
    def __init__(self, embeddings,
        ...
        """
        super(ProjectedMultiHeadedAttentionRNN, self).__init__()
